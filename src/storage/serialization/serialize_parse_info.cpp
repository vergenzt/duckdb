...
void AttachInfo::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<unique_ptr<ParsedExpression>>(204, "parsed_path", parsed_path);
	serializer.WritePropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(205, "parsed_options", parsed_options);
}
...
unique_ptr<ParseInfo> AttachInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<unique_ptr<ParsedExpression>>(204, "parsed_path", result->parsed_path);
	deserializer.ReadPropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(205, "parsed_options", result->parsed_options);
	return std::move(result);
}
...
void ConnectInfo::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(204, "parsed_options", parsed_options);
}
...
unique_ptr<ParseInfo> ConnectInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(204, "parsed_options", result->parsed_options);
	return std::move(result);
}
...
void CopyInfo::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(210, "parsed_options", parsed_options);
}
...
unique_ptr<ParseInfo> CopyInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<case_insensitive_map_t<unique_ptr<ParsedExpression>>>(210, "parsed_options", result->parsed_options);
